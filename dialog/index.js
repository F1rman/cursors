...
$(document).ready(() => {
  var html = function () {
    if (Math.random() > 0.5) {
      return '<a target="_blank" href="https://chrome.google.com/webstore/detail/style-cursor/njbgkalfmgkchikknmaimfjmfjpnbnpm/reviews" class="rete">☆☆☆ Rate The App ☆☆☆</a>';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $(".cursor").hover(
    function () {
      ...
      changeHoverClassTimer = setInterval(function () {
        changeHoverHandler(that);
      }, 750);
    },
    function () {
...
function changeHoverHandler(elem) {
  if (!isDisplayingHoverCursor) addCursorHoverClass(elem);
  else removeCursorHoverClass(elem);
}
